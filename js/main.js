...
function openModal() {
  ...
  hasHorizontalScrollbar = projectModal.children[0].scrollWidth > projectModal.children[0].clientWidth;
  hasVerticalScrollbar = projectModal.children[0].scrollHeight > projectModal.children[0].clientHeight;
...
function showModal(e) {
  ...
  switch (e.target.id) {
    ...
    // =============== //
    case 'project-1':
      title.textContent = 'I-Special Wears';
      ...
      var lis = [createListItem('HTML'), createListItem('CSS'), createListItem('WordPress')];

      // Call the function
      appendChildren(ul, lis);

      // Reset link defaults
      websiteBtn.href = 'https://ispecialwears.com';
      githubBtn.href = 'https://github.com/SeikyouP/new-ispecialwears';
